...
# pacman packages
pacman -S networkmanager wofi stow kitty flatpak curl yay hyprland hyprpaper neovim discord qtcreator git gcc raylib yazi fastfetch lua nodejs npm sddm ttf-jetbrains-mono-nerd ttf-hack-nerd 
